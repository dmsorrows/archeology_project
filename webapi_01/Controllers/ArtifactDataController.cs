...
public class ArtifactDataController : ControllerBase
{
    ...
    public Response InsertArtifact(string periodName, string level1Id, string level2Id, string level3Id, string? level4Id, string? additionalDescription, string artifactCount, string artifactWeight, string labTechInitials, string provenienceId)
    {
        ...
        try
        {
            ...
            ArtifactData artifact = new ArtifactData(periodName, Convert.ToInt32(level1Id), Convert.ToInt32(level2Id), Convert.ToInt32(level3Id), Convert.ToInt32(level4Id), additionalDescription, Convert.ToInt32(artifactCount), Convert.ToDecimal(artifactWeight), labTechInitials, Convert.ToInt32(provenienceId));
